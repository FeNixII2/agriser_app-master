...
class ProvEditProfile extends StatefulWidget with DrawerStates {
  @override
  _ProvEditProfileState createState() => _ProvEditProfileState();
}

class _ProvEditProfileState extends State<ProvEditProfile> {
  @override
  void initState() {
    super.initState();
