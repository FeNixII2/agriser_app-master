...
class Prov_schedule_success extends StatefulWidget {
  final SearchType searchType;

  Prov_schedule_success({Key key, this.searchType}) : super(key: key);
  @override
  _Prov_schedule_successState createState() => _Prov_schedule_successState();
}

class _Prov_schedule_successState extends State<Prov_schedule_success> {
  ...
  Future getreply() async {
    FirebaseAuth ww = FirebaseAuth.instance;
    String uid_user = ww.currentUser.uid.toString();
    await reply.doc("Success_prov").collection(uid_user).get().then((value) {
