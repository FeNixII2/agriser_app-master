...
import 'info_agw.dart';

class Type_AGW extends StatefulWidget {
  @override
  _Type_AGWState createState() => _Type_AGWState();
}

class _Type_AGWState extends State<Type_AGW> {
  List providerList = [];
  CollectionReference provi = FirebaseFirestore.instance.collection("ListAGW");
